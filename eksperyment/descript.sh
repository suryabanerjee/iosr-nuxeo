...
#java -cp $XLIFF_PATH XliffConverter/XliffConvert mary.html 2 pl
java -cp $XLIFF_PATH XliffConverter/XliffConvert mary.pdf 2 pl
#java -cp $XLIFF_PATH XliffConverter/XliffConvert mary.txt 2 pl
#java -cp $XLIFF_PATH XliffConverter/XliffConvert mary.xml 2pl
#java -cp $XLIFF_PATH XliffConverter/XliffConvert mary.properties 2 pl
#java -cp $XLIFF_PATH XliffConverter/XliffConvert mary.doc 2 pl
#java -cp $XLIFF_PATH XliffConverter/XliffConvert mary.odt 2 pl
